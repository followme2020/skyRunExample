package com.example.skyrunexample.Sellers;
...
import com.example.skyrunexample.R;
...
public class SellerRegistrationActivity extends AppCompatActivity
{
    ...
    private void registerSeller()
    {
        ...
        {
            Toast.makeText(this, "Please fill up all registration Form", Toast.LENGTH_SHORT).show();
        }
