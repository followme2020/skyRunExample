...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private EditText InputProductName, InputProductDescription, InputPrice;
    ...
    private void StoreImageInformation()
    {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            {
                Toast.makeText(AdminAddNewProductActivity.this, "Image uploaded succesfuly", Toast.LENGTH_SHORT).show();
